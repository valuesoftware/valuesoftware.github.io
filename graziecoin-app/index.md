...
### Ranking
その日のグラッチェをした/されたユーザをランキング形式で表示する画面です。
サービス利用開始から通算のランキングと、1日ごとのランキングを表示します。
タブを切り替えるとサービスを利用する組織全体や事業所ごとの表示になります。
※サービス契約区分が会社の場合は「事業所」タブは表示されません

<img alt="すべてのランキング" src="img/ranking.png" width="300">
<img alt="事業所別ランキング" src="img/ranking2.png" width="300">
